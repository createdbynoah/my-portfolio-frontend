            ...
            <div className="about__noah-text">
              ...
              <p>
                <ul>
                  ...
                  <li>
                    a collaborator — always looking for ways to help others
                    around him.
                  </li>
                  <li>
                    expressive and energetic — definitely the guy at the party
                    in the very middle causing a scene in an effort to ensure
          ...
          <div className="about__interests">
            <div className="about__interests-text">
              ...
              <p>
                ...
                in the spotlight and can hold my own in front of a crowd. I'm .
                I love to collaborate with those around me and I'm always
